...
<table align="center">
  <tr>
    <td align="center" width="50%"><img src="docs/screenshots/timer_light.png" width="220" alt="タイマー画面（ライトテーマ・デフォルト）"/><br/><sub><b>タイマー（ライト）</b></sub></td>
    <td align="center" width="50%"><img src="docs/screenshots/timer_monokai.png" width="220" alt="タイマー画面（Monokaiテーマ）"/><br/><sub><b>タイマー（Monokai）</b></sub></td>
  </tr>
  <tr>
    <td align="center" width="50%"><img src="docs/screenshots/timer_purple.png" width="220" alt="タイマー画面（Catppuccinテーマ）"/><br/><sub><b>タイマー（Catppuccin）</b></sub></td>
    <td align="center" width="50%"><img src="docs/screenshots/task_preset.png" width="220" alt="タスク名プリセット選択"/><br/><sub><b>タスクプリセット選択</b></sub></td>
  </tr>
  <tr>
    <td align="center" width="50%"><img src="docs/screenshots/worklog.png" width="220" alt="作業ログ画面（サマリー＋グラフ）"/><br/><sub><b>作業ログ</b></sub></td>
    <td align="center" width="50%"><img src="docs/screenshots/settings_theme.png" width="220" alt="カラーテーマ選択"/><br/><sub><b>テーマ選択</b></sub></td>
  </tr>
  <tr>
    <td align="center" width="50%"><img src="docs/screenshots/settings_notification.png" width="220" alt="通知・サイクル自動開始設定"/><br/><sub><b>通知・サイクル設定</b></sub></td>
    <td align="center" width="50%"><img src="docs/screenshots/settings_discord_rpc.png" width="220" alt="Discord RPC連携設定"/><br/><sub><b>Discord RPC連携</b></sub></td>
  </tr>
</table>
...
- タスク別の累計ポモドーロ数・作業時間ランキング（比例バー付き）
